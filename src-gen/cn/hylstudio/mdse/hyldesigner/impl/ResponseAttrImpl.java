...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Response Attr</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link cn.hylstudio.mdse.hyldesigner.impl.ResponseAttrImpl#getDto <em>Dto</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponseAttrImpl extends AttrImpl implements ResponseAttr {
	/**
	...
	protected EClass eStaticClass() {
		return HyldesignerPackage.Literals.RESPONSE_ATTR;
	}
	...
	public EList<Dto> getDto() {
		if (dto == null) {
			dto = new EObjectContainmentEList<Dto>(Dto.class, this, HyldesignerPackage.RESPONSE_ATTR__DTO);
		}
		return dto;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HyldesignerPackage.RESPONSE_ATTR__DTO:
